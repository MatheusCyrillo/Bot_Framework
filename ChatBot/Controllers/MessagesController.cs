                    ...
                    if (intencao != null && topScore >= 0.8)
                    {
                        ...
                        switch (intencao)
                        {
                            ...
                            case "Ver":
                                ...
                                if (privateConversationData.GetProperty<bool>("VerVencimento"))
                                {
                                    reply = activity.CreateReply($"Você já viu seu vencimento!");
                                     connector.Conversations.ReplyToActivity(reply);
                                    break;
                                }
                                ...
                                privateConversationData.SetProperty<bool>("VerVencimento", true);
